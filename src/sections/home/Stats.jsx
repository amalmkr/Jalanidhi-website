    ...
    return(
        ...
        <section>
            <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mt-10 md:mt-5 p-5 md:px-20 ">
                    <div className="bg-blue-500 min-h-[150px] md:min-h-[200px] rounded-2xl hover:bg-blue-800">
                    ...
                    <div className="bg-blue-500 min-h-[150px] md:min-h-[200px] rounded-2xl hover:bg-blue-800">
                        <p className="text-center mt-5 text-base md:text-xl text-white font-bold">PWSS Population Benefited</p>
